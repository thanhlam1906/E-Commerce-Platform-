package com.example.productcatalogservice.constant;

public final class ErrorMessages {

    private ErrorMessages() {}

    public static final String CATEGORY_NOT_FOUND = "Danh mục không tìm thấy";
    ...
    public static final String PRODUCT_SLUG_EXISTS = "Slug sản phẩm đã tồn tại";
